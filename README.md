...
**84 features documented** across 11 categories. Coverage is ongoing.
...
| Doc | What it covers |
|-----|---------------|
| [System Requirements](11-security-and-compliance/feature-audit-logging.md) | Power Platform audit, Purview, routing table audit |
...
- Voice: ACS PSTN provisioning, Direct Routing, Calling Plans, predictive/progressive dialling, callback, E911, music on hold, phone number porting
- Digital messaging: email channel, proactive chat, persistent chat, co-browse, WeChat
- Routing: intelligent skill finder, effort estimation
- Agent experience: swarming, email threading
- Copilot: case assist (legacy)
- WFM: intraday dashboard (appears retired/merged)
- Extensibility: Channel Integration Framework v2, Power Virtual Agents migration path

---

*Last updated: 2026-04-30 · 84 features documented*
